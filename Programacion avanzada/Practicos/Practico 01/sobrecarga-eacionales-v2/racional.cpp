...
Racional Racional::suma(const Racional &r){
	...
	*/
	...
	return Racional(numA + numB, mcm);
}


Racional Racional::diferencia(const Racional &r){
	/* 	Hay dos casos:
	...
	*/
	if (this->den == r.get_denominador()){
		return Racional(this->num - r.get_numerador(), this->den);
	}else{
		return Racional((this->num * r.get_denominador()) - (this->den * r.get_numerador()), this->den * r.get_denominador());
	}
}


Racional Racional::producto(const Racional &r){
	// Multiplicar los de arriba y multiplicar los de abajo
	return Racional(this->num * r.get_numerador(), this->den * r.get_denominador());
}


Racional Racional::cociente(const Racional &r){
	/* Multiplicar en cruz
	...
	*/
	return Racional(this->num * r.get_denominador(), this->den * r.get_numerador());
}


Racional Racional::reducir() const {
	...
	*/
	...
	// nota: como el this es un puntero, al hacer return de una copia, se llama con *this ya que el constructor recibe un objeto, no un puntero
	...
	for (int i = 2; i <= this->num; i++){
		if (this->num % i == 0 && this->den % i == 0){
			return Racional(this->num / i, this->den / i); 
		}
	}
...
bool Racional::igualdad(const Racional &r){
	...
	// Aca no se si hay que liberar memoria, nunca hice un new, asi que supongo que no...
	// r1.~Racional();
	//  r2.~Racional();
	return ret;
}
...
Racional operator -(const Racional &r1, const Racional &r2){
	...
	*/
	if (r1.den == r2.den){
		return Racional(r1.num - r2.num, r1.den);
	}else{
		return Racional((r1.num * r2.den) - (r1.den * r2.num), r1.den * r2.den);
	}
}
...
Racional operator *(const Racional &r1, const Racional &r2){
	// Multiplicar los de arriba y multiplicar los de abajo
	return Racional(r1.num * r2.num, r1.den * r2.den);
}
...
Racional operator /(const Racional &r1, const Racional &r2){
	...
	denominador final = denominador de la primera * numerador de la segunda
	*/
	return Racional(r1.num * r2.den, r1.den * r2.num);
}
